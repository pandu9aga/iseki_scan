...
class UserRackController extends Controller
{
    public function index()
    {
        $rack = Rack::orderBy('Code_Rack', 'asc')->get();
        return view('users.racks.index', compact('rack'));
    }

    public function add()
    {
        return view('users.racks.add');
    }
    ...
    {
        return view('users.racks.edit', compact('Id_Rack'));
    }
    ...
    {
        return view('users.racks.upload'); // View form upload
    }
    ...
    public function type()
    {
        ...
        return view('users.racks.type', compact('rack'));
    }

    public function typeEdit($Id_Rack)
    {
        $rack = Rack::where('Id_Rack', $Id_Rack)->first();
        return view('users.racks.type_edit', compact('rack'));
    }
    ...
    {
        return view('users.racks.type_upload');
    }
