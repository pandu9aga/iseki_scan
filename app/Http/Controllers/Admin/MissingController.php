...
class MissingController extends Controller
{
    ...
    //     $requests = RequestModel::with('member', 'record')->orderBy('Day_Request', 'desc')->get();
    ...
    //     // Header kolom
    //     $headers = ['No', 'Time Request', 'Time Record', 'Item', 'Rack', 'Sum Request', 'Sum Record', 'Member', 'Updated'];
