            ...
            <div class="row">
                <div class="col">
                    <div class="p-5">
                        ...
                        @endif
                        <form class="user text-center" action="{{ route('record.create') }}" id="recordForm"
                                    ...
                                    <div class="form-group mb-3">
                                        <div>
                                            {{-- <span style="font-size: small;">QR Code Item</span>
                                                <div id="parent_qrcode"
                                                    class="container-fluid d-flex justify-content-start p-0"
                                ...
                                <div class="col-12 text-center">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="Sum_Record" id="Sum_Record"
                                            ...
                                            value="{{ old('Sum_Record') }}" min="1" step="1" required>
                                        @error('Sum_Record')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header bg-danger text-white">
                                        <h5 class="modal-title">Tidak ada request</h5>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center flex-wrap" style="gap:8px;">
            ...
            <div class="d-flex align-items-center">
                ...
                <input type="date" id="filterDateRec" class="form-control form-control-sm mx-1" style="width:auto;min-width:130px;max-width:160px;" onchange="loadRecordData()">
...
<script>
    ...
    function resolveRequest() {
        ...
        let sumRecord = $("#Sum_Record").val();
        if (!sumRecord) {
            alert("Sum Record harus diisi.");
            return;
        }
    ...
    function loadRecordData() {
        ...
        $.get('{{ route("record.data") }}', {
            ...
            if (res.records.length === 0) {
                ...
                info.textContent = 'Total: 0 record';
                return;
            }
