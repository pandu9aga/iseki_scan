...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-3 border-left-primary">
        <div class="card-body py-2 px-3">
            <form method="GET" action="{{ route('admin.check') }}" class="form-inline d-flex align-items-center flex-wrap">
                ...
                <div class="mt-2 mt-md-0">
                    ...
                    <a href="{{ route('admin.check', ['target_date' => \Carbon\Carbon::today()->format('Y-m-d')]) }}" class="btn btn-danger btn-sm mr-1"><i class="fas fa-calendar-day"></i> Cek Hari Ini</a>
                    <a href="{{ route('admin.check') }}" class="btn btn-outline-secondary btn-sm"><i class="fas fa-sync-alt"></i> Reset</a>
                </div>
            </form>
        </div>
    </div>
