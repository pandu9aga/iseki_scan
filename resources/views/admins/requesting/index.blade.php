...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-2 text-gray-800" id="top">Requesting</h1>
            ...
            <div class="row">
                <div class="col">
                    <div class="p-5">
                        ...
                        @endif
                        <form class="user text-center" action="{{ route('admin.requesting.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
...
<script>
    ...
    function checkDuplicateRequest(codeRack, onClear) {
        ...
        $.ajax({
            url: '{{ route("admin.requesting.checkDuplicate") }}',
            method: 'POST',
            data: {
                Code_Rack: codeRack,
                _token: $('meta[name="csrf-token"]').attr('content')
...
<form id="checkForm" action="{{ route('admin.check.store') }}" method="POST" style="display:none;">
    @csrf
