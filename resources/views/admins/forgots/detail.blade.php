                        ...
                        <tbody>
                            @foreach($forgots as $index => $f)
                                <tr>
                                    ...
                                    <td>{{ ($f->request && $f->request->member) ? $f->request->member->Name_Member : '-' }}</td>
                                    <td>{{ ($f->request && $f->request->record && $f->request->record->member) ? $f->request->record->member->Name_Member : '-' }}
                                    </td>
