    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <div class="p-5">
                        <form class="user" action="{{ route('item.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group mb-3">
                                        <span style="font-size: small;">Item Name</span>
                                        <input type="text" name="Name_Item" class="form-control form-control-user @error('Name_Item') is-invalid @enderror" value="{{ old('Name_Item') }}">
                                        @error('Name_Item')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="Code_Item" name="Code_Item" class="form-control form-control-user @error('Code_Item') is-invalid @enderror" value="{{ old('Code_Item') }}">
                                        @error('Code_Item')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
