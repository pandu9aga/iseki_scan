    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('/') }}">
                ...
                <div class="sidebar-brand-text mx-3">Iseki QC</div>
            </a>
            ...
            <!-- Nav Item - Withdrawal -->
            <li class="nav-item {{ request()->routeIs('qc.withdrawal') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('qc.withdrawal') }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Iseki QC</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
